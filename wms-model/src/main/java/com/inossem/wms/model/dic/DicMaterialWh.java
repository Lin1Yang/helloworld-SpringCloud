...
@ApiModel(value="com.inossem.wms.model.dic.DicMaterialWh", description="物料仓库数据对象")
public class DicMaterialWh extends DicMaterialWhKey {
	
	@ApiModelProperty(value="物料组", name="matGroupCode",example="01", required=true)
	...
	@ApiModelProperty(value="仓库计量单位", name="unitCode",example="CDM", required=true)
    private String whUnitCode;
    ...
    public String getWhUnitCode() {
        return whUnitCode;
    }

    public void setWhUnitCode(String whUnitCode) {
        this.whUnitCode = whUnitCode;
    }
