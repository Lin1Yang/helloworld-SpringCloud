...
@ApiModel(value="com.inossem.wms.model.sinobec.SinobecBizOutput")
public class SinobecBizOutput {
    @ApiModelProperty(value="outputId")
    ...
    @ApiModelProperty(value="receiptBid单据第3级序号")
    ...
    @ApiModelProperty(value="shippingRef运输单号")
    ...
    @ApiModelProperty(value="stockId仓位id")
    ...
    @ApiModelProperty(value="traillerNumber   （拖车编号）")
    private String  traillerNumber;
    ...
    @ApiModelProperty(value = "Added for batch_new from SAP",example = "...")
    private String ext3;
    
    private String ext4;

    @ApiModelProperty(value = "Added for batch_split from SAP",example = "Y or N")
    private String ext5;
	...
	public String getTraillerNumber() {
        return traillerNumber;
    }

    public void setTraillerNumber(String traillerNumber) {
        this.traillerNumber = traillerNumber;
    }
